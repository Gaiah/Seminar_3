...
<img align="right" src="Git-logo.png" alt="git logo" width="300"/> 
</br></br></br></br>
...
Эта команда позволяет закомментировать коммит
...
Эта команда удаляет выбранную ветку из репозитория
